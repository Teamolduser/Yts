      ...
      1: [
        function (require, module, exports) {
          ...
          function search(query, callback) {
            ...
            function callback_with_retry(err, data) {
              if (err) {
                if (
                  _options._attempts >
                  (_options.MAX_RETRY_ATTEMPTS || MAX_RETRY_ATTEMPTS)
                ) {
                  ...
                  var wait_ms =
                    Math.pow(2, n - 1) *
                    (_options.RETRY_INTERVAL || RETRY_INTERVAL);
                  setTimeout(function () {
          ...
          function getSearchResults(_options, callback) {
            ...
            var pageEnd =
              Number(_options.pageEnd) || Number(_options.pages) || 1;
          ...
          function _parseSearchResultInitialData(responseText, callback) {
            ...
            for (var _i = 0; _i < items.length; _i++) {
              ...
              var listId =
                hasList && _jp.value(item, "$..watchEndpoint..playlistId");
                  ...
                  case "list":
                    {
                      ...
                      var _author_url =
                        ...
                        "";
                      var video_count_label = _jp.value(
                        item,
                  ...
                  case "channel":
                    {
                      ...
                      var about_channel =
                        _jp
                          .query(
                            item,
                            "$..channelRenderer..descriptionSnippet..text",
                          )
                          .join("") || "";
                      var _video_count_label =
                        _jp.value(item, "$..videoCountText..simpleText") ||
                        _jp.value(item, "$..videoCountText..label") ||
                        _jp.value(item, "$..videoCountText..text") ||
                        "0";
                      var channel_verified_label =
                        _jp.value(
                          item,
                          "$..channelRenderer..ownerBadges..style",
                        ) ||
                        _jp.value(
                          item,
                          "$..channelRenderer..ownerBadges..tooltip",
                        ) ||
                        _jp.value(
                          item,
                          "$..channelRenderer..ownerBadges..label",
                        ) ||
                        "";
                      ...
                      result = {
                        ...
                        videoCount: Number(
                          _parseNumbers(_video_count_label)[0],
                        ),
                  ...
                  case "live":
                    {
                      ...
                      var scheduledDateString =
                        _toInternalDateString(scheduledTime);
                  ...
                  function (err, r) {
                    ...
                    var _loop = function _loop() {
                        ...
                        if (
                          video.videoId != null &&
                          video.videoId ===
                            (v === null || v === void 0 ? void 0 : v.videoId)
                        ) {
          ...
          function _parseDuration(timestampText) {
            ...
            while (
              (_timestamp = timestamp[timestamp.length - 1]) !== null &&
              _timestamp !== void 0 &&
              _timestamp.match(/\D/)
            ) {
              var _timestamp;
          ...
          function test(query) {
            ...
            search(opts, function (error, r) {
              ...
              console.log(
                "topChannel.subCountLabel: " + topChannel.subCountLabel,
              );
